"""
Training script for Super Resolution model
Trains EDSR-style model to achieve PSNR >= 24 dB on validation set
"""
...
def main():
    ...
    config = {
        'num_channels': 64,
        'num_blocks': 12,  # Increase from 8 to 12 for better performance
        'batch_size': 8,
        'num_epochs': 200,
        'lr': 1e-4,
        'lr_decay_step': 50,
